...
from model3_raw import flng_model
...
path=args.filepath
filename= "graph_{}_p{}_N{}{}estkm_{}est_k{}.RData".format(args.type, args.p, args.N, args.noise, args.km, args.k)
true_param = load_Rparams(path, filename)
filename= "data_{}_p{}_N{}{}estkm_{}est_k{}.RData".format(args.type, args.p, args.N, args.noise, args.km, args.k)
data = load_Rdata(path,filename)

p = args.p
k = args.k
km = [args.km,args.km] #M=2
eta_a = args.lr_a
eta_b = args.lr_b
...
def run_single_model(s):
    ...
    tpr, fpr = model.fit( X, tol, true_tildeB = true_param['tildeB'], evaluate=False, iniA=data['A'], iniB=None, thre=args.thre)
...
savefile = "model3_{}_p{}_N{}_I{}{}_km{}_k{}_thre{}_rate{}{}{}_run8".format(args.type, args.p, args.N, args.init, args.noise, args.km, args.k,
