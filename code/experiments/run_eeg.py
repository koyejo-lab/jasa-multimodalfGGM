...
fmri = np.array(robjects.r['data'][0])[0:23]#[23:46]
eeg = np.array(robjects.r['data'][1])[0:23]#[23:46]
...
np.save('experiment_result_eeg_rest_all_firsr23.npy', results[0])
keys = results[0].keys()
with open("./experiment_result_eeg_rest_all_first23.csv", "w", newline='') as output_file:
